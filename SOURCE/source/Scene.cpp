...
#pragma region Base Scene
	...
	void dae::Scene::GetClosestHit(const Ray& ray, HitRecord& closestHit) const
	{
		...
		{
			GeometryUtils::HitTest_Sphere(m_SphereGeometries[index], ray, checkHit);

			if (checkHit.didHit)
			{

				if (checkHit.t < closestHit.t)
				{
					closestHit = checkHit;
				}
			}
		...
		{
			GeometryUtils::HitTest_Plane(m_PlaneGeometries[index], ray, checkHit);
		...
		{
			GeometryUtils::HitTest_TriangleMesh(m_TriangleMeshGeometries[index], ray, checkHit);
